      ...
      <Container className="container-2" maxWidth="xl">
        <Container className="container-inner" maxWidth="md">
          ...
          <p className="description">
            Hello, my name is Hai, a Year 2 <strong>Computer Science</strong> student in the <strong>National University
            of Singapore</strong>. I love what I am studying and I am still in the midst of exploring all the possibilites
            ...
            Right now, I'm looking for opportunities that will broaden my skillset and knowledge,
            while at the same time allow me to contribute and leave a positive impact.
            <br /><br />
