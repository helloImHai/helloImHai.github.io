        ...
        <Fade big cascade duration={2000} fraction={0.5} triggerOnce={true}>
          <Container className="container-inner" maxWidth="md">
            ...
            <p className="description">
              <br />
              Hello, my name is Hai, a Year 3 <strong>
                Computer Science
              </strong>{" "}
              student at the <strong>National University of Singapore</strong>.
              I love what I am studying and I am still in the midst of exploring
              all the possibilities that comes with diving into the field of
              ...
              looking for opportunities that will broaden my skills and
              knowledge, while at the same time allow me to contribute and leave
              a positive impact.
              <br />
              <br />
              When I am not coding I like kayaking, eating, and gymming. A weird
              hobby of mine is translating English songs into different
              languages.
              <br />
              <br />
            </p>
